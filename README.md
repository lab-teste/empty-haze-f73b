...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "calm-snowflake-b091-d1":

```bash
npx wrangler d1 create calm-snowflake-b091-d1
```
